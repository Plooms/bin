...
mv -v Bering\ Sea\ Gold\ Under\ the\ Ice\ -\ \[*					"$TV_SYM"/"Bering Sea Gold Under the Ice"/              2>/dev/null && echo -e "\n\n"
...
mv -v Bobs\ Burgers\ -\ \[*					"$TV_SYM"/"Bob's Burgers"/              2>/dev/null && echo -e "\n\n"
mv -v Body\ of\ Proof\ -\ \[*					"$TV_SYM"/"Body of Proof"/              2>/dev/null && echo -e "\n\n"
mv -v Border\ Security\ -\ \[*					"$TV_SYM"/"Border Security"/              2>/dev/null && echo -e "\n\n"
mv -v Bored\ to\ Death\ -\ \[*					"$TV_SYM"/"Bored to Death"/              2>/dev/null && echo -e "\n\n"
mv -v Bosch\ -\ \[*					"$TV_SYM"/"Bosch"/              2>/dev/null && echo -e "\n\n"
...
mv -v Castle\ \(2009\)\ -\ \[*					"$TV_SYM"/"Castle (2009)"/              2>/dev/null && echo -e "\n\n"
mv -v Chappelles\ Show\ -\ \[*					"$TV_SYM"/"Chappelle's Show"/              2>/dev/null && echo -e "\n\n"
...
mv -v Deadbeat\ -\ \[*					"$TV_SYM"/"Deadbeat"/              2>/dev/null && echo -e "\n\n"
...
mv -v Dirty\ Money\ \(2011\)\ -\ \[*					"$TV_SYM"/"Dirty Money (2011)"/              2>/dev/null && echo -e "\n\n"
...
mv -v Extreme\ Makeover\ Home\ Edition\ -\ \[*					"$TV_SYM"/"Extreme Makeover Home Edition"/              2>/dev/null && echo -e "\n\n"
...
mv -v Game\ of\ Thrones\ -\ \[*					"$TV_SYM"/"Game of Thrones"/              2>/dev/null && echo -e "\n\n"
mv -v George\ Lopez\ -\ \[*					"$TV_SYM"/"George Lopez"/              2>/dev/null && echo -e "\n\n"
mv -v Getting\ On\ \(US\)\ -\ \[*					"$TV_SYM"/"Getting On (US)"/              2>/dev/null && echo -e "\n\n"
mv -v Golden\ Boy\ -\ \[*					"$TV_SYM"/"Golden Boy"/              2>/dev/null && echo -e "\n\n"
mv -v Golden\ Boy\ \(2013\)\ -\ \[*					"$TV_SYM"/"Golden Boy (2013)"/              2>/dev/null && echo -e "\n\n"
...
mv -v Hot\ in\ Cleveland\ -\ \[*					"$TV_SYM"/"Hot in Cleveland"/              2>/dev/null && echo -e "\n\n"
...
mv -v How\ I\ Met\ Your\ Mother\ -\ \[*					"$TV_SYM"/"How I Met Your Mother"/              2>/dev/null && echo -e "\n\n"
mv -v How\ Its\ Made\ -\ \[*					"$TV_SYM"/"How Its Made"/              2>/dev/null && echo -e "\n\n"
...
mv -v Human\ Target\ \(2010\)\ -\ \[*					"$TV_SYM"/"Human Target (2010)"/              2>/dev/null && echo -e "\n\n"
...
mv -v Las\ Vegas\ -\ \[*					"$TV_SYM"/"Las Vegas"/              2>/dev/null && echo -e "\n\n"
...
mv -v Louie\ \(2010\)\ -\ \[*					"$TV_SYM"/"Louie (2010)"/              2>/dev/null && echo -e "\n\n"
...
mv -v MythBusters\ -\ \[*					"$TV_SYM"/"MythBusters"/              2>/dev/null && echo -e "\n\n"
mv -v NCIS\ -\ \[*					"$TV_SYM"/"NCIS"/              2>/dev/null && echo -e "\n\n"
mv -v NCIS\ Los\ Angeles\ -\ \[*					"$TV_SYM"/"NCIS Los Angeles"/              2>/dev/null && echo -e "\n\n"
mv -v Necessary\ Roughness\ -\ \[*					"$TV_SYM"/"Necessary Roughness"/              2>/dev/null && echo -e "\n\n"
mv -v Nip_Tuck\ -\ \[*					"$TV_SYM"/"Nip_Tuck"/              2>/dev/null && echo -e "\n\n"
...
mv -v Parks\ and\ Recreation\ -\ \[*					"$TV_SYM"/"Parks and Recreation"/              2>/dev/null && echo -e "\n\n"
mv -v Pawn\ Stars\ -\ \[*					"$TV_SYM"/"Pawn Stars"/              2>/dev/null && echo -e "\n\n"
mv -v Person\ of\ Interest\ -\ \[*					"$TV_SYM"/"Person of Interest"/              2>/dev/null && echo -e "\n\n"
mv -v Pimp\ My\ Ride\ -\ \[*					"$TV_SYM"/"Pimp My Ride"/              2>/dev/null && echo -e "\n\n"
...
mv -v Sons\ of\ Anarchy\ -\ \[*					"$TV_SYM"/"Sons of Anarchy"/              2>/dev/null && echo -e "\n\n"
mv -v Sons\ of\ Guns\ -\ \[*					"$TV_SYM"/"Sons of Guns"/              2>/dev/null && echo -e "\n\n"
...
mv -v Surviving\ the\ Cut\ -\ \[*					"$TV_SYM"/"Surviving the Cut"/              2>/dev/null && echo -e "\n\n"
mv -v Switched\ at\ Birth\ -\ \[*					"$TV_SYM"/"Switched at Birth"/              2>/dev/null && echo -e "\n\n"
mv -v Tanked\ -\ \[*					"$TV_SYM"/"Tanked"/              2>/dev/null && echo -e "\n\n"
mv -v That\ 70s\ Show\ -\ \[*					"$TV_SYM"/"That 70's Show"/              2>/dev/null && echo -e "\n\n"
...
mv -v The\ Border\ -\ \[*					"$TV_SYM"/"The Border"/              2>/dev/null && echo -e "\n\n"
mv -v The\ Cleveland\ Show\ -\ \[*					"$TV_SYM"/"The Cleveland Show"/              2>/dev/null && echo -e "\n\n"
...
mv -v The\ Fresh\ Prince\ of\ Bel-Air\ -\ \[*					"$TV_SYM"/"The Fresh Prince of Bel-Air"/              2>/dev/null && echo -e "\n\n"
...
mv -v The\ Rebels\ -\ \[*					"$TV_SYM"/"The Rebels"/              2>/dev/null && echo -e "\n\n"
...
mv -v Top\ 20\ Most\ Shocking\ -\ \[*					"$TV_SYM"/"Top 20 Most Shocking"/              2>/dev/null && echo -e "\n\n"
mv -v Top\ Shot\ -\ \[*					"$TV_SYM"/"Top Shot"/              2>/dev/null && echo -e "\n\n"
mv -v Touch\ \(2012\)\ -\ \[*					"$TV_SYM"/"Touch (2012)"/              2>/dev/null && echo -e "\n\n"
...
mv -v Man\ Finds\ Food\ -\ \[*					"$TV_SYM"/"Man Finds Food"/              2>/dev/null && echo -e "\n\n"
mv -v Partners\ \(2014\)\ -\ \[*					"$TV_SYM"/"Partners (2014)"/              2>/dev/null && echo -e "\n\n"
mv -v Jennifer\ Falls\ -\ \[*					"$TV_SYM"/"Jennifer Falls"/              2>/dev/null && echo -e "\n\n"
mv -v The\ Beverly\ Hillbillies\ -\ \[*					"$TV_SYM"/"The Beverly Hillbillies"/              2>/dev/null && echo -e "\n\n"
mv -v Walker,\ Texas\ Ranger\ -\ \[*					"$TV_SYM"/"Walker, Texas Ranger"/              2>/dev/null && echo -e "\n\n"
mv -v The\ Bridge\ \(2013\)\ -\ \[*                "$TV_SYM"/"The Bridge (2013)"/              2>/dev/null && echo -e "\n\n"
mv -v The\ Last\ Ship\ -\ \[*					"$TV_SYM"/"The Last Ship"/              2>/dev/null && echo -e "\n\n"
mv -v The\ Leftovers\ -\ \[*					"$TV_SYM"/"The Leftovers"/              2>/dev/null && echo -e "\n\n"
mv -v Sleepy\ Hollow\ -\ \[*					"$TV_SYM"/"Sleepy Hollow"/              2>/dev/null && echo -e "\n\n"
mv -v Extant\ -\ \[*					"$TV_SYM"/"Extant"/              2>/dev/null && echo -e "\n\n"
mv -v Tyrant\ -\ \[*					"$TV_SYM"/"Tyrant"/              2>/dev/null && echo -e "\n\n"
mv -v Mom\ -\ \[*					"$TV_SYM"/"Mom"/              2>/dev/null && echo -e "\n\n"
mv -v Crossbones\ -\ \[*					"$TV_SYM"/"Crossbones"/              2>/dev/null && echo -e "\n\n"
mv -v Gang\ Related\ -\ \[*					"$TV_SYM"/"Gang Related"/              2>/dev/null && echo -e "\n\n"
mv -v The\ Night\ Shift\ -\ \[*					"$TV_SYM"/"The Night Shift"/              2>/dev/null && echo -e "\n\n"
mv -v Young\ \&\ Hungry\ -\ \[*					"$TV_SYM"/"Young & Hungry"/              2>/dev/null && echo -e "\n\n"
mv -v Manhattan\ -\ \[*					"$TV_SYM"/"Manhattan"/              2>/dev/null && echo -e "\n\n"
mv -v Undateable\ \(2014\)\ -\ \[*					"$TV_SYM"/"Undateable (2014)"/              2>/dev/null && echo -e "\n\n"
...
if [ -f "Utopia (U) (2014) - ["* ]
then echo "found the shit" && sleep 2
